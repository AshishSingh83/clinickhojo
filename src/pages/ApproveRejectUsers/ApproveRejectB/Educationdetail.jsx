...
const Educationdetail = ({ BasicDetail, onRadioChange, radioData }) => {
  const [doctorEducationDetailOption, setDoctorEducationDetailOption] = useState("");
  ...
  const renderDetails =
    BasicDetail.length === 0 ? (
      ...
      <div className="h-[240px] items-center">
        <div key={BasicDetail[0].degreeName} className="w-[420px] h-[185px] mb-4 rounded-sm ms-3 mt-5 text-white opacity-75">
          <div className="font-medium ms-2 mb-5 ">
            <div className="mt-1 flex flex-row gap-3">
              <label className="font-sm">College:</label>
              <input type="text" value={BasicDetail[0].collegeName} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">Degree:</label>
              <input type="text" value={BasicDetail[0].degreeName} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">Field Of Study:</label>
              <input type="text" value={BasicDetail[0].fieldOfStudy} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">Start Date:</label>
              <input type="text" value={BasicDetail[0].startDate} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">End Date:</label>
              <input type="text" value={BasicDetail[0].passingYear} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div>
              <span
                className={`${variable} inline-block rounded-md cursor-pointer h-9 px-4 py-1 m-1 ms-72 text-sm text-white pt-2 bg-[#0032FF]`}
                onClick={() => handleViewProofClick(BasicDetail[0].certificates[0])}
              >
                View Proof
              </span>
            </div>
      ...
      BasicDetail.map((update) => (
        <div key={update.degreeName} className="w-[420px] h-[185px] mb-4 rounded-sm ms-3 text-white">
          <div className="font-medium ms-2 mb-5">
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">College:</label>
              <input type="text" value={update.collegeName} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">Degree:</label>
              <input type="text" value={update.degreeName} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">Field Of Study:</label>
              <input type="text" value={update.fieldOfStudy} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">Start Date:</label>
              <input type="text" value={update.startDate} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div className="mt-2 flex flex-row gap-3">
              <label className="font-sm">End Date:</label>
              <input type="text" value={update.passingYear} readOnly className="bg-[#FFFFFF] bg-opacity-80 border-none text-black rounded-sm text-center ms-3 text-opacity-100" />
            </div>
            <div >
              <div
  ...
  return (
    <div style={{ width: "450px" }} className="bg-[#03229F] text-white">
      <div className="mt-[-12px] rounded-md flex flex-row gap-14">
        <h2 className="text-lg p-2 font-medium">Education Details</h2>
        <div className="mt-3">
          <RadioButtons handleChange={handleChange} selectedOption={doctorEducationDetailOption} />
        </div>
      </div>
      <div style={{ overflow: "auto", maxHeight: "425px" }}>
        {renderDetails}
