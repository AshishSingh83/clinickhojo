...
//       try {
//         const [pendingResponse,pendingHospitalRes, changedResponse] = await Promise.all([
...
//         setPendingHospital(pendingHospitalRes.data || []);
//           useMemo(() => {
//           const approved = [];
//           const notApproved = [];
//           pendingHospitalRes.forEach(update => {
...
//           </div>
//           <div className="  me-32">
//             <DemoHospital bg1="bg-[#845BB3]" bg2="bg-blue-300" bg3="bg-[#f089a4]" text='Pending Profiles Of Hospital ...' showData={pendingHospital} newBg="bg-[#229649]" newBga="#229649" />
//           </div>
//         </div>
//       </div>
//     </div>
