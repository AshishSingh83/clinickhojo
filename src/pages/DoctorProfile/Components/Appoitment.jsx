...
const Appoiment = ({ dataa = { appointments: [] }, loading }) => {
      ...
      >
        <div className="text-black font-medium">
          ...
          <div className="opacity-75">
            ...
            {/* Assuming update.BookedOn is some additional data */}
            {update.BookedOn}
          </div>
        </div>
        {update.type === "emergency" && (
  ...
  return (
    <div style={{ backgroundColor: "#03229F", width: "530px", height: "470px" }}>
      <div className="h-14 flex items-center bg-[#FFFFFF] text-[#FA0808] text-2xl justify-center font-medium">
      ...
      {loading ? (
        <div className="flex items-center justify-center h-full">
          <div className="mb-14">
            <Spinner height="h-[70px]" width="w-[70px]" fontSize="text-[.9rem]" />
          </div>
        </div>
      ) : (
        <div style={{ overflow: "auto", maxHeight: "400px" }} className="mt-4">
