...
const InputWithPassword = ({
  ...
  const iconClass =
    "h-7 w-7 absolute right-5 top-1/2 transform -translate-y-1/2 text-gray-400 ps-2 ";
  ...
  return (
    <div className="relative p-2">
      ...
      />
      <IconComponent className="h-5 w-6 absolute left-5 top-1/2 transform -translate-y-1/2 text-gray-400" />
      {type === "password" && (
        <div
